...
namespace MCP.Editor.ServerManager
{
    ...
    {
        // MCPサーバーの名前
        public const string ServerName = "rpgmaker-mcp";
        ...
        public static string UserInstallPath
        {
            get
            {
                ...
                return Path.Combine(userProfile, "RPGMaker-Unite-MCP");
            }
        }
        ...
        public static string SourcePath
        {
            get
            {
                ...
                // ローカルパッケージの場合
                return Path.Combine(Application.dataPath, "RPGMakerMCP", "MCPServer");
            }
        }
